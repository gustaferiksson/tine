...
export type SettingsMap = {
    [key in SETTINGS]?: unknown;
};
export declare const updateSettings: (newSettings: SettingsMap) => void;
export declare const getSetting: <T = unknown>(key: SETTINGS, defaultValue?: any) => T;
export declare const getSettings: () => SettingsMap;
